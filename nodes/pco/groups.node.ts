...
import * as doc from './openapi_groups.json'; // <=== Your OpenAPI v3 spec
...
export class groups implements INodeType {
  description: INodeTypeDescription = {
    ...
    description: 'Interact with Planning Center Groups API',
    defaults: {
